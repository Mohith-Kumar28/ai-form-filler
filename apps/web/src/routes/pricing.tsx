  ...
  return (
    <div className="pt-24 pb-20 md:pt-32 md:pb-28">
      <div className="mx-auto max-w-6xl px-6">
        <Reveal>
          <p className="text-[13px] font-semibold uppercase tracking-[0.1em] text-center text-accent">Pricing</p>
        ...
        <Reveal delay={0.2} className="mt-20">
          <div className="mx-auto max-w-2xl space-y-4 rounded-xl border border-border bg-surface-raised p-7">
            ...
            <div className="space-y-3 text-[13px] leading-relaxed text-ink-muted">
              <p>
                <strong className="text-ink">Can I switch plans?</strong> Yes. Upgrade or
                downgrade any time. Your form count resets at the start of each billing month.
              </p>
              <p>
                <strong className="text-ink">What counts as a form?</strong> Each time you
                click &ldquo;Fill&rdquo; and Fillaform processes a page, that is one form fill —
                regardless of how many fields.
              </p>
              <p>
                <strong className="text-ink">Do you store my data?</strong> Your sources
                (resume, links, notes) are stored so Fillaform can search them at fill time. You can
                delete everything from the extension settings.
              </p>
              <p>
                <strong className="text-ink">What payment methods do you accept?</strong> All
                major cards and UPI through our payment partner, Dodo Payments.
              </p>
            </div>
          </div>
        </Reveal>
